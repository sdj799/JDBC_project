...
import com.java.user.repository.UserRepositiory;
...
public class UserService implements AppService{
	...
	private final UserRepositiory userRepositiory = new UserRepositiory();
	...
	private void deleteUser() {
		...
		if(showSearchResult() > 0) {
			...
			userRepositiory.deleteUser(delUserNum);
		}
